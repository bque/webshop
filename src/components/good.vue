<template>
	...
	<div class="good" v-for="(value,index) in goodsList">
		...
		<p class="goodBottom"> <a >{{value.OperatingA}}</a><a>{{value.OperatingB}}</a> </p>
	</div>
	</div>
</template>
...
.goodBottom{border-bottom: 3px solid #f0f0f0;height: 3rem; line-height: 3rem;text-align: right;}

.goodBottom a{padding: 0.2rem 1rem;font-size: 0.8rem; border: 1px solid darkgray; border-radius: 15px;margin-right: 1rem;}
</style>